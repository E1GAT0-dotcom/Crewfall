...
const ROWS: readonly Row[] = [
  ...
  { key: 'crewVision', label: 'Crew view distance', kind: 'number', suffix: 'x', help: 'How far the camera is zoomed out for crew. Bots see the same distance.' },
  { key: 'impostorVision', label: 'Impostor view distance', kind: 'number', suffix: 'x', help: 'How far the camera is zoomed out for impostors.' },
